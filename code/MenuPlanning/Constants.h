...
const std::array<std::string, num_nutr> ingRNames = {
    "Ácido Fólico", "Calcio",     "Energía",     "Fósforo",     "Grasas",
    "Hierro",       "Magnesio",   "Potasio",     "Proteínas",   "Selenio",
    "Sodio",        "Vitamina A", "Vitamina B1", "Vitamina B2", "Vitamina B6",
    "Vitamina B12", "Vitamina C", "Vitamina D",  "Vitamina E",  "Yodo",
    "Zinc"};
