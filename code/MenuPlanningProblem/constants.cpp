...
// Nutrientes claves
const int keyEnergy = 2;
const int keyFats = 4;
const int keyProteins = 8;

const double ingR_rangMin_Keys = 0.90;			//1.5	- 2
const double ingR_rangMax_Keys = 1.10;		//2		- 1.7
const double ingR_rangMin_Rest = 0.70;
const double ingR_rangMax_Rest = 1.30;